...
- **Biographie du défunt** : une page dédiée pour recueillir auprès de la famille les informations utiles à l'éloge (naissance, scolarité, frères et sœurs, rencontre du conjoint, enfants, vie professionnelle, passions, anecdotes…), avec un bouton pour assembler une première ébauche de texte à partir de ces informations (accord grammatical selon le genre renseigné) — pas de génération par IA, juste un montage de phrases à relire et personnaliser, à copier ou insérer directement dans une étape du déroulé.
