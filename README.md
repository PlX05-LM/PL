...
- **Bibliothèque de poèmes** : une dizaine de poèmes de grands auteurs (Hugo, Ronsard, Baudelaire, Verlaine, Nerval, Musset, Sully Prudhomme, Chénier…), tous dans le domaine public, classés par situation de deuil (mort d'un enfant ou d'une personne jeune, deuil périnatal, mort brutale ou accidentelle, après un suicide, grand âge, séparation, grands classiques) avec une note d'adaptation pour chacun, à insérer dans une étape en un clic.
